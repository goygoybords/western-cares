    ...
    <footer>          
      <div class="container">
        <div class="row">
          <div class="col-md-6 ">
            <h3>Stay Updated!</h3>
            <p>Sign-up now and be the first to find out about our <br>
              latest news and promotions of up to <strong>10% OFF</strong>!<br>
              💌</p>
              <form action="#">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-sm-6 col-xs-12">
            <a href="#" class="text-white mr-3">Terms &amp; Conditions</a>
    ...
    <script type="text/javascript" src="<?=base_url();?>resources/js/popper.min.js"></script>
    <script type="text/javascript" src="<?=base_url();?>resources/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="<?=base_url();?>resources/js/jquery.mixitup.js"></script>
    ...
    <script type="text/javascript" src="<?=base_url();?>resources/js/wow.js"></script>   
    <script type="text/javascript" src="<?=base_url();?>resources/js/jquery.vide.js"></script>
    ...
    <script type="text/javascript">
      $(function(ready)
      {
        ...
        {
            phone: true,
            phoneRegionCode: $("#select-country-edit").val(),
        });
