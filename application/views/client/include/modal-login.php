      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body px-4">
            <form id = "loginForm">
                <p class="mt-3">
                    <strong>Enter your email address and password to continue</strong>
                    <div id = "error_mesage" style="color:red;"></div>
                </p>
                <div class="form-group">
                  <input class="form-control" value="" id = "txtEmail" required type="email">
            ...
            <div class="py-4 text-muted text-center">
               <a href = "" id = "signup-tab" class="text-muted"><u>Sign Up Here</u></a>
            </div>
          </div>
        </div>
      </div>
