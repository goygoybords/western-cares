    <div class="modal modal-fullscreen fade" id="addBooking" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static"
         data-keyboard="false">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <?php echo form_open('add_booking', array('id' => 'addBookingForm')); ?>
              <div class="modal-body" style="padding: 25px;">
                ...
                <div class = "row">
                  <div class="col-md-2">
                    <div class="form-group">
                          ...
                          <select class="form-control" id="lashSlot"></select>
                        </div>
                  </div>
                </div>
                ...
                <div class = "row">
                  <div class="col-md-2">
                      <div class="form-group">
                         <label for="txtAddress">TIME:</label>
                         <select class="form-control" id="browsSlot"></select>
                      </div>
                  </div>
                </div>
                    <div class="form-group">
                ...
                <!-- TABLE -->
                <table id="tblServiceItems" class="table table-condensed table-striped table-hover">
                  <thead>
                    <tr>
                      <th>Customer Name </th>
                      <th>Service Name</th>
